...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("data/data_cianten_hulu.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cianten Hulu',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cianten_tengah.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cianten Tengah',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cianten_hilir.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cianten Hilir',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
