...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("data/data/data/data_ciluar_hulu.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Ciluar Hulu',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data/data_ciluar_tengah.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Ciluar Tengah',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_ciluar_hilir.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Ciluar Hilir',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
