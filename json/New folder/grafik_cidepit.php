...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("data/data_cidepit_hulu.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cidepit Hulu',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cidepit_tengah.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cidepit Tengah',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cidepit_hilir.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Cidepit Hilir',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
