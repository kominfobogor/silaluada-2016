...
<html>
	<head>
		...
		<title>HASIL UJI AIR SUNGAI SITU PANJANG </title>
...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("data/data_situ_panjang_inlet.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Situ Panjang Inlet',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_situ_panjang_outlet.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian Situ Panjang Outlet',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
