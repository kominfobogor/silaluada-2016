...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("data/data_cisindangbarang_hulu.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian cisindangbarang Hulu',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cisindangbarang_tengah.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian cisindangbarang Tengah',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
...
$(function () {
    var chart;
    $(document).ready(function() {
        $.getJSON("data/data_cisindangbarang_hilir.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            title: {
	                text: 'Hasil Pengujian cisindangbarang Hilir',
	                x: -20 //center
	            },
	            subtitle: {
	                text: '',
