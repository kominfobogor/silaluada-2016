...
$sth = mysql_query("SELECT temperature FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows = array();
...
$sth = mysql_query("SELECT tds FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows2 = array();
$rows2['name'] = 'TDS';
while($r = mysql_fetch_array($sth)) {
    $rows2['data'][] = $r['tds'];
...
$sth = mysql_query("SELECT tss FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows4 = array();
$rows4['name'] = 'TSS';
while($r = mysql_fetch_array($sth)) {
    $rows4['data'][] = $r['tss'];
...
$sth = mysql_query("SELECT debit FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows6 = array();
$rows6['name'] = 'Debit';
while($r = mysql_fetch_array($sth)) {
    $rows6['data'][] = $r['debit'];
...
$sth = mysql_query("SELECT ph FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows8 = array();
$rows8['name'] = 'PH';
while($r = mysql_fetch_array($sth)) {
    $rows8['data'][] = $r['ph'];
...
$sth = mysql_query("SELECT bod FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows11 = array();
$rows11['name'] = 'BOD';
while($r = mysql_fetch_array($sth)) {
    $rows11['data'][] = $r['bod'];
...
$sth = mysql_query("SELECT cod FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows13 = array();
$rows13['name'] = 'COD';
while($r = mysql_fetch_array($sth)) {
    $rows13['data'][] = $r['cod'];
...
$sth = mysql_query("SELECT do FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows15 = array();
$rows15['name'] = 'DO';
while($r = mysql_fetch_array($sth)) {
    $rows15['data'][] = $r['do'];
...
$sth = mysql_query("SELECT 	total_phospate_po4 FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows17 = array();
...
$sth = mysql_query("SELECT 	nitrate_no3 FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows19 = array();
...
$sth = mysql_query("SELECT 	arsenic_as FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows21 = array();
...
$sth = mysql_query("SELECT 	cobalt_co FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows23 = array();
...
$sth = mysql_query("SELECT 	boron_b FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows25 = array();
$rows25['name'] = 'boron_b';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	selenium_se FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows27 = array();
...
$sth = mysql_query("SELECT 	cadmium_cd FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows29 = array();
...
$sth = mysql_query("SELECT 	chrom_hexavalen_cr6 FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows31 = array();
...
$sth = mysql_query("SELECT 	copper_cu FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows33 = array();
...
$sth = mysql_query("SELECT 	lead_pb FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows35 = array();
$rows35['name'] = 'lead_pb';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	mercury_hg FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows37 = array();
...
$sth = mysql_query("SELECT 	zinc_zn FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows39 = array();
$rows39['name'] = 'zinc_zn';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	cyanide_cn FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows41 = array();
...
$sth = mysql_query("SELECT 	flouride_f FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows43 = array();
...
$sth = mysql_query("SELECT 	nitrite_no2 FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows45 = array();
...
$sth = mysql_query("SELECT 	free_chlorine_cl2 FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows47 = array();
...
$sth = mysql_query("SELECT 	sulfide_h2s FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows49 = array();
...
$sth = mysql_query("SELECT 	ammonia FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows51 = array();
$rows51['name'] = 'ammonia';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	chloride_cl FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows53 = array();
...
$sth = mysql_query("SELECT 	iron_fe FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows55 = array();
$rows55['name'] = 'iron_fe';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	manganese_mn FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows57 = array();
...
$sth = mysql_query("SELECT 	barium_ba FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows59 = array();
...
$sth = mysql_query("SELECT 	sulfat FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows61 = array();
$rows61['name'] = 'sulfat';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	fecal_coliform FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows63 = array();
...
$sth = mysql_query("SELECT 	total_coliform FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows65 = array();
...
$sth = mysql_query("SELECT 	oil_fat FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows67 = array();
$rows67['name'] = 'oil_fat';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	detergent_mbas FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows69 = array();
...
$sth = mysql_query("SELECT 	phenol FROM `pengujian_sungai` WHERE nama_sungai = 'CIBALOK-Hilir'");
$rows71 = array();
$rows71['name'] = 'phenol';
while($r = mysql_fetch_array($sth)) {
