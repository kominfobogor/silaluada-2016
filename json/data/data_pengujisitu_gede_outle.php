...
$sth = mysql_query("SELECT temperature FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows = array();
...
$sth = mysql_query("SELECT tds FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows2 = array();
$rows2['name'] = 'TDS';
while($r = mysql_fetch_array($sth)) {
    $rows2['data'][] = $r['tds'];
...
$sth = mysql_query("SELECT tss FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows4 = array();
$rows4['name'] = 'TSS';
while($r = mysql_fetch_array($sth)) {
    $rows4['data'][] = $r['tss'];
...
$sth = mysql_query("SELECT debit FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows6 = array();
$rows6['name'] = 'Debit';
while($r = mysql_fetch_array($sth)) {
    $rows6['data'][] = $r['debit'];
...
$sth = mysql_query("SELECT ph FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows8 = array();
$rows8['name'] = 'PH';
while($r = mysql_fetch_array($sth)) {
    $rows8['data'][] = $r['ph'];
...
$sth = mysql_query("SELECT bod FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows11 = array();
$rows11['name'] = 'BOD';
while($r = mysql_fetch_array($sth)) {
    $rows11['data'][] = $r['bod'];
...
$sth = mysql_query("SELECT cod FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows13 = array();
$rows13['name'] = 'COD';
while($r = mysql_fetch_array($sth)) {
    $rows13['data'][] = $r['cod'];
...
$sth = mysql_query("SELECT do FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows15 = array();
$rows15['name'] = 'DO';
while($r = mysql_fetch_array($sth)) {
    $rows15['data'][] = $r['do'];
...
$sth = mysql_query("SELECT 	total_phospate_po4 FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows17 = array();
...
$sth = mysql_query("SELECT 	nitrate_no3 FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows19 = array();
...
$sth = mysql_query("SELECT 	arsenic_as FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows21 = array();
...
$sth = mysql_query("SELECT 	cobalt_co FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows23 = array();
...
$sth = mysql_query("SELECT 	boron_b FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows25 = array();
$rows25['name'] = 'boron_b';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	selenium_se FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows27 = array();
...
$sth = mysql_query("SELECT 	cadmium_cd FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows29 = array();
...
$sth = mysql_query("SELECT 	chrom_hexavalen_cr6 FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows31 = array();
...
$sth = mysql_query("SELECT 	copper_cu FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows33 = array();
...
$sth = mysql_query("SELECT 	lead_pb FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows35 = array();
$rows35['name'] = 'lead_pb';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	mercury_hg FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows37 = array();
...
$sth = mysql_query("SELECT 	zinc_zn FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows39 = array();
$rows39['name'] = 'zinc_zn';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	cyanide_cn FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows41 = array();
...
$sth = mysql_query("SELECT 	flouride_f FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows43 = array();
...
$sth = mysql_query("SELECT 	nitrite_no2 FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows45 = array();
...
$sth = mysql_query("SELECT 	free_chlorine_cl2 FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows47 = array();
...
$sth = mysql_query("SELECT 	sulfide_h2s FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows49 = array();
...
$sth = mysql_query("SELECT 	ammonia FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows51 = array();
$rows51['name'] = 'ammonia';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	chloride_cl FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows53 = array();
...
$sth = mysql_query("SELECT 	iron_fe FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows55 = array();
$rows55['name'] = 'iron_fe';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	manganese_mn FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows57 = array();
...
$sth = mysql_query("SELECT 	barium_ba FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows59 = array();
...
$sth = mysql_query("SELECT 	sulfat FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows61 = array();
$rows61['name'] = 'sulfat';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	fecal_coliform FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows63 = array();
...
$sth = mysql_query("SELECT 	total_coliform FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows65 = array();
...
$sth = mysql_query("SELECT 	oil_fat FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows67 = array();
$rows67['name'] = 'oil_fat';
while($r = mysql_fetch_array($sth)) {
...
$sth = mysql_query("SELECT 	detergent_mbas FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows69 = array();
...
$sth = mysql_query("SELECT 	phenol FROM `pengujian_situ` WHERE nama_situ = 'Situ Gede-Outlet'");
$rows71 = array();
$rows71['name'] = 'phenol';
while($r = mysql_fetch_array($sth)) {
