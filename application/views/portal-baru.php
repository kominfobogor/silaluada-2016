...
<body>
    ...
    <div class="container" style="width: 900px; box-shadow: 1px 1px 5px;">
        <div class="row">
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                			<img class="img img-responsive img-slide" src="<?php echo base_url()?>assets/css/image/2.jpg" style="width:100%">
                        </div>
                         
                        <div class="item">
                            <img class="img img-responsive img-slide" src="<?php echo base_url()?>assets/css/image/1.jpg" style="width:100%">
                        </div>
                    </div>
    ...
    <!-- Page Content -->
    <div class="container" style="width: 900px; box-shadow: 1px 1px 10px;">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <p>
                                ...
                                ?>
                                        <img style="width: 100px;height: 100px;padding-right: 10px;" class="pull-left img img-responsive" src="<?php echo base_url('uploads/galeri/'.$g->image)?>">
