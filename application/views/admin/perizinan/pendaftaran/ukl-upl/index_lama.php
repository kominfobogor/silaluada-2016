...
<section class="content">
    ...
    <table class="table table-bordered table-hover" id="example1">
      ...
      <td><?php echo $row->permohonan_id ?></td>
        ...
        <td>
         ...
         <!-- <a href="<?php echo site_url('adm_sppl/approve?tabel=uklupl&primary='.$rows->sppl_lama_id.'&url=adm_sppl')?>" class="btn btn-xs bg-blue" data-toggle="tooltip" title="Ubah Status Permohonan" onclick="return confirm('Ini akan merubah status permohonan menjadi sudah diterima, lanjutkan?')"><i class="fa fa-check-square"></i></a> 
  ...
  <?php $this->load->view('admin/perizinan/pendaftaran/ukl-upl/modal'); ?>
