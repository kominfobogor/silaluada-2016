  ...
  <div class="box">
    ...
    <table class="table table-bordered table-hover" id="example1">
     ...
     -->
      ...
      <a href="<?php echo site_url('trash/proses?tabel=amdal&primary='.$row->permohonan_id.'&url=adm_perizinan_amdal')?>" class="btn btn-xs bg-red" data-toggle="tooltip" title="Hapus Data" onclick="return confirm('Anda yakin??')" data-placement="left"><i class="fa fa-trash-o"></i></a>
