  ...
  <div class="col-lg-4">
    ...
    <div class="box">
      <div class="box-header with-border">
        <strong>Form Import Pengujian Sungai</strong>
      </div>
      <div class="box-header with-border">
        
      <a href="<?php echo base_url('assets/excel/import-sungai.xls')?>"><button class="btn-warning btn-lg"> Download Format </button></a>
      
      </div>
        <div class="box-body">
          <?php echo form_open_multipart('adm_pengujian_sungai/importcsv')?>
        <?php echo form_close();?>
		<div class="form-group">
          <label>Import</label>
		  <form method="post" action="<?php echo base_url() ?>index.php/adm_pengujian_sungai/importcsv" enctype="multipart/form-data">
