...
*/
class Adm_pengujian_sungai extends CI_Controller
{
	...
	function index()
	{
		$data['title'] = "Import Data Pengujian Sungai";
		$data['konten'] = 'admin/csv/sungai/index';
		$link = 'Adm_pengujian_sungai/index/';
		$limit= 10;
		$uri_segment= 3;
        ...
        if (!$this->upload->do_upload()) {
            ...
            if ($this->csvimport->get_array($file_path)) {
                ...
                foreach ($csv_array as $row) {
                    ...
                    $this->supermodel->insert_csv('pengujian_sungai',$insert_data);
                }
				$data['error'] = "Sukses";
                redirect("adm_pengujian_sungai/index");
